...
class CFGBuilder(ast.NodeVisitor):
    ...
    def build(
        ...
        return self.cfg, mylist

    def build_from_src(self, name: str, src: str) -> tuple:
        """
        ...
        cfg, mylist = self.build(name, tree)
        cfg.lineno = 1
        cfg.end_lineno = len(src.splitlines())
        return cfg, mylist

    def build_from_file(self, name: str, filepath: str) -> tuple:
        """
    ...
    def clean_cfg(self, block: Block, visited: Set[Block]) -> CFG:
    ...
    def create_jsondata(self, block: Block,visited: Set[Block], mylist=list[dict]) -> List:
        """"
        my code starts here
        generate json file for cleaned up code
